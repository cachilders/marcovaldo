...
### Module Inclusion and Global Instance Pattern
...
- **Global Instance Access**
  - Global instances (e.g., `cat_breed_registry`) are initialized in `init_observables()`
...
- **Dependency Order**
  - Always initialize shared resources before their consumers
  - Example order:
